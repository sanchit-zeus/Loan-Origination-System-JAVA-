...
public class LoanDetails extends Database{
	...
	void creditscore() {
		...
		if(asset-liability>loanamount)
			creditscore=creditscore+2;
		else if(asset-liability<loanamount)
		...
		if(type.equals("education"))
			System.out.println("The loan granted is: "+loanamount*1*+creditscore*.1);
		else if(type.equals("personal"))
			System.out.println("The loan granted is: "+loanamount*1*+creditscore*.1);
		else if(type.equals("house"))
			System.out.println("The loan granted is: "+loanamount*.85*+creditscore*.1);
		else if(type.equals("car"))
			System.out.println("The loan granted is: "+loanamount*.55*+creditscore*.1);			
	    }
		}
	}
}